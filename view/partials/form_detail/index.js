...
Component({
  ...
  methods: {
        ...
        for (let i = 0; i < formData.items.length; i++) {
          if (formData.items[i].listValues && (formData.items[i].type == 2 || formData.items[i].type == 4 || formData.items[i].type == 3)) {
            ...
            if (formData.items[i].type == 3) {
              ...
              console.log("=======showRadioState========", showRadioState, radioChildrenList, haveRadioChildrenList, controlFieldShow)
              that.setData({ showRadioState: showRadioState, radioChildrenList: haveRadioChildrenList })
            }
    ...
    radioChange: function (e) {
      ...
      console.log("===controlFieldShow===", controlFieldShow, radioChildrenList)
